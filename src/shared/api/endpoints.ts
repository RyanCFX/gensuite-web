export const ENDPOINTS = {
  me: {
    ...
    mfaTotp: '/me/mfa/totp',
    mfaTotpConfirm: '/me/mfa/totp/confirm',
    mfaEmail: '/me/mfa/email',
    mfaFactor: (factorId: string) => `/me/mfa/${encodeURIComponent(factorId)}`,
    identities: '/me/identities',
    identity: (identityId: string) => `/me/identities/${encodeURIComponent(identityId)}`,
  },
  auth: {
    login: '/auth/login',
    ...
    invitationAccept: (token: string) => `/auth/invitations/${encodeURIComponent(token)}/accept`,
    invitationReject: (token: string) => `/auth/invitations/${encodeURIComponent(token)}/reject`,
  ...
  compras: {
    ...
    // Relaciones Comerciales — Fase 09/11 (docs/tasks/relaciones_comerciales)
    enviarAProveedor: (id: string) => `/compras/${id}/enviar-a-proveedor`,
    cancelarEnvio: (id: string) => `/compras/${id}/cancelar-envio`,
    estadoSocio: (id: string) => `/compras/${id}/estado-socio`,
    enlazarYEnviar: (id: string) => `/compras/${id}/enlazar-y-enviar`,
  },
  purchaseReceipt: {
  ...
  solicitudesCompra: {
    ...
    byId: (id: string) => `/compras/solicitudes/${id}`,
    submit: (id: string) => `/compras/solicitudes/${id}/submit`,
    cancel: (id: string) => `/compras/solicitudes/${id}/cancel`,
    amend: (id: string) => `/compras/solicitudes/${id}/amend`,
    detener: (id: string) => `/compras/solicitudes/${id}/detener`,
    reanudar: (id: string) => `/compras/solicitudes/${id}/reanudar`,
    generarOrden: (id: string) => `/compras/solicitudes/${id}/generar-orden`,
    pdf: (id: string) => `/compras/solicitudes/${id}/pdf`,
  },
  ordenesCompra: {
    list: '/compras/ordenes',
    byId: (id: string) => `/compras/ordenes/${id}`,
    submit: (id: string) => `/compras/ordenes/${id}/submit`,
    cancel: (id: string) => `/compras/ordenes/${id}/cancel`,
    amend: (id: string) => `/compras/ordenes/${id}/amend`,
    cerrar: (id: string) => `/compras/ordenes/${id}/cerrar`,
    reabrir: (id: string) => `/compras/ordenes/${id}/reabrir`,
    enEspera: (id: string) => `/compras/ordenes/${id}/en-espera`,
    recibir: (id: string) => `/compras/ordenes/${id}/recibir`,
    facturar: (id: string) => `/compras/ordenes/${id}/facturar`,
    pdf: (id: string) => `/compras/ordenes/${id}/pdf`,
    pendientesAbastecimiento: '/compras/ordenes/pendientes-abastecimiento',
    desdePedidos: '/compras/ordenes/desde-pedidos',
  },
  pedidos: {
    list: '/pedidos',
  ...
  usuarios: {
    list: '/usuarios',
    lookup: '/usuarios/lookup',
    byEmail: (email: string) => `/usuarios/${email}`,
    reinvitar: (email: string) => `/usuarios/${encodeURIComponent(email)}/reinvitar`,
    suspender: (email: string) => `/usuarios/${encodeURIComponent(email)}/suspender`,
    reactivar: (email: string) => `/usuarios/${encodeURIComponent(email)}/reactivar`,
  ...
  monedas: {
    list: '/monedas',
    byCode: (code: string) => `/monedas/${encodeURIComponent(code)}`,
    tasas: '/monedas/tasas',
    tasasVigente: '/monedas/tasas/vigente',
    tasasById: (id: string) => `/monedas/tasas/${encodeURIComponent(id)}`,
    tasasSincronizar: '/monedas/tasas/sincronizar',
    convertir: '/monedas/convertir',
    previewConversionBanco: '/monedas/preview-conversion-banco',
  },
  pos: {
  ...
  reportes: {
    ...
    facturacionFiscal: '/reportes/dgii/facturacion-fiscal',
    facturacionFiscalPdf: '/reportes/dgii/facturacion-fiscal/pdf',
    // docs/tasks/62_reportes_solicitados_y_reportes_nuevos.md — 9 reportes nativos nuevos
    flujoEfectivo: '/reportes/flujo-efectivo',
    flujoEfectivoPdf: '/reportes/flujo-efectivo/pdf',
    comprasAnalitica: '/reportes/compras/analitica',
    comprasAnaliticaPdf: '/reportes/compras/analitica/pdf',
    comprasRegistro: '/reportes/compras/registro',
    ...
    pedidosAnaliticaPdf: '/reportes/pedidos/analitica/pdf',
    comprasOrdenesAnalitica: '/reportes/compras/ordenes-analitica',
    comprasOrdenesAnaliticaPdf: '/reportes/compras/ordenes-analitica/pdf',
    inventarioAntiguedad: '/reportes/inventario/antiguedad',
    inventarioAntiguedadPdf: '/reportes/inventario/antiguedad/pdf',
    inventarioProyeccion: '/reportes/inventario/proyeccion',
    inventarioProyeccionPdf: '/reportes/inventario/proyeccion/pdf',
    // docs/tasks/62_reportes_solicitados_y_reportes_nuevos.md §Parte 1 — reportes async
    inventarioMovimientosSolicitar: '/reportes/inventario/movimientos/solicitar',
    solicitudes: '/reportes/solicitudes',
    solicitudById: (id: string) => `/reportes/solicitudes/${encodeURIComponent(id)}`,
    // docs/tasks/PROMPT_DESPACHO_RESERVAS_ABASTECIMIENTO_FRONTEND.md §9 — sin PDF, tabla nativa
    despachoMargen: '/reportes/despacho/margen',
    despachoReservas: '/reportes/despacho/reservas',
    despachoFaltantes: '/reportes/despacho/faltantes',
    despachoPendientesCompra: '/reportes/despacho/pendientes-compra',
  },
  cuentasMovimientos: {
  ...
  cuentasBancarias: {
    ...
    inconsistenciasMoneda: '/cuentas-bancarias/inconsistencias-moneda',
    bancos: {
  ...
  despachos: {
    list: '/despachos',
    pendientes: '/despachos/pendientes',
    byId: (id: string) => `/despachos/${encodeURIComponent(id)}`,
    desdePedido: (soId: string) => `/despachos/desde-pedido/${encodeURIComponent(soId)}`,
    desdeFactura: (siId: string) => `/despachos/desde-factura/${encodeURIComponent(siId)}`,
    asignarTracking: (id: string) => `/despachos/${encodeURIComponent(id)}/asignar-tracking`,
    confirmarStock: (id: string) => `/despachos/${encodeURIComponent(id)}/confirmar-stock`,
    submit: (id: string) => `/despachos/${encodeURIComponent(id)}/submit`,
    cancel: (id: string) => `/despachos/${encodeURIComponent(id)}/cancel`,
  ...
  apertura: {
    ...
    preparar: '/apertura/preparar',
    ventas: {
      list: '/apertura/ventas',
      byId: (id: string) => `/apertura/ventas/${encodeURIComponent(id)}`,
      cancel: (id: string) => `/apertura/ventas/${encodeURIComponent(id)}/cancel`,
      importar: '/apertura/ventas/importar',
    },
    compras: {
      list: '/apertura/compras',
      byId: (id: string) => `/apertura/compras/${encodeURIComponent(id)}`,
      cancel: (id: string) => `/apertura/compras/${encodeURIComponent(id)}/cancel`,
  ...
  relaciones: {
    directorioBuscar: '/relaciones/directorio/buscar',
    invitaciones: {
      list: '/relaciones/invitaciones',
      byId: (id: string) => `/relaciones/invitaciones/${encodeURIComponent(id)}`,
      cancelar: (id: string) => `/relaciones/invitaciones/${encodeURIComponent(id)}/cancelar`,
      reenviar: (id: string) => `/relaciones/invitaciones/${encodeURIComponent(id)}/reenviar`,
      aceptar: (id: string) => `/relaciones/invitaciones/${encodeURIComponent(id)}/aceptar`,
      rechazar: (id: string) => `/relaciones/invitaciones/${encodeURIComponent(id)}/rechazar`,
      // Público — sin login
      porToken: (token: string) => `/relaciones/invitaciones/token/${encodeURIComponent(token)}`,
      porTokenAceptar: (token: string) => `/relaciones/invitaciones/token/${encodeURIComponent(token)}/aceptar`,
      porTokenRechazar: (token: string) => `/relaciones/invitaciones/token/${encodeURIComponent(token)}/rechazar`,
    },
    bloqueos: {
      list: '/relaciones/bloqueos',
      levantar: (id: string) => `/relaciones/bloqueos/${encodeURIComponent(id)}/levantar`,
    },
    list: '/relaciones',
    ...
    suspender: (id: string) => `/relaciones/${encodeURIComponent(id)}/suspender`,
    reactivar: (id: string) => `/relaciones/${encodeURIComponent(id)}/reactivar`,
    terminar: (id: string) => `/relaciones/${encodeURIComponent(id)}/terminar`,
    documentosEnlazables: (id: string) => `/relaciones/${encodeURIComponent(id)}/documentos-enlazables`,
    mapeoAcumulado: (id: string) => `/relaciones/${encodeURIComponent(id)}/mapeo`,
    transacciones: {
      list: '/relaciones/transacciones',
      byId: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}`,
      aceptar: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}/aceptar`,
      rechazar: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}/rechazar`,
      ...
      igualarConEnmienda: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}/igualar-con-enmienda`,
      candidatosEnlace: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}/candidatos-enlace`,
      enlazar: (uid: string) => `/relaciones/transacciones/${encodeURIComponent(uid)}/enlazar`,
    },
    ventas: {
